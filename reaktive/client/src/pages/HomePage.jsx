...
const HomePage = ({ time, weather, location, lights, climate, security, toggleLight }) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try { await haService.connectWebSocket(); } catch (e) { console.warn('HA WS connect failed in HomePage', e); }
      ...
      } catch (e) { console.warn('HomePage discovery failed', e); }

      try { haService.subscribeToEntity('state_changed', onStateChanged); } catch (e) { console.warn('HomePage subscribe failed', e); }
    })();
